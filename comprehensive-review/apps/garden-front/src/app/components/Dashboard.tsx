...
import { PageSection, Title, PageSectionVariants, Card, CardBody, CardTitle, Grid, GridItem, Gallery, GalleryItem, Text, TextVariants, CardHeader, Skeleton } from "@patternfly/react-core";
    ...
    return (<React.Fragment>
        ...
        <PageSection>
            <Card>
                ...
                <CardBody >
                    <Text component={TextVariants.small}>Garden aggregated data</Text>
                </CardBody>
                <CardBody>
