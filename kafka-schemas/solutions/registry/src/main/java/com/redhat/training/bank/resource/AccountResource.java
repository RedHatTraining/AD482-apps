...
public class AccountResource {
    ...
    @Inject @Channel("bank-account-balance-out")
    Emitter<BankAccountBalanceWasChanged> balanceEmitter;
    ...
    public BankAccount deposit(@PathParam Long id, DepositAmountInBankAccount deposit) {
        ...
        notifyAboutBalanceChange(entity);
    ...
    {
        LOGGER.info(
                "Notifying bank account creation - ID: " + bankAccount.id
    ...
    private void notifyAboutBalanceChange(BankAccount entity)
    {
        ...
        balanceEmitter.send(
                new BankAccountBalanceWasChanged(
                        entity.id,
                        entity.balance
                )
        );
